...
export class AdminViewFeedback extends Component
{
    constructor(props){
        super(props);
        this.state = {
            ...
            my = Object.keys(this.state.myfeed).map((key)=>{
                return(
                    <div className="jobview">
                        <p className="jobviewheading">Name:   {this.state.myfeed[key].name}</p>
                        <p className="jobviewheading">Email:   {this.state.myfeed[key].email}</p> 
